...
class MainActivityViewModel @Inject constructor(val userRepository: UserRepository) : ViewModel() {
    ...
    fun customUserRegister(userModel: UserModel){
        viewModelScope.launch {
            val result = userRepository.customUserRegister(userModel)
